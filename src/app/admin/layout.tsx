    ...
    <div className="min-h-screen bg-background flex">
      ...
      `}>
        ...
        <div className="p-4 border-t border-border mt-auto">
          ...
          <button onClick={handleLogout} className="w-full flex items-center justify-center gap-2 px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-red-500 border border-red-500/20 hover:bg-red-500/10 transition-colors">
      ...
      <main className="flex-1 p-6 md:p-12 min-h-screen md:ml-64 transition-all duration-300">
        <div className="md:hidden mb-6 flex items-center justify-between border-b border-border pb-4">
          <button onClick={() => setIsMobileMenuOpen(true)} className="p-2 text-foreground hover:text-accent transition-colors">
